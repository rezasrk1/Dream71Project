...
output_path = os.path.join(output_dir, "fd7_form.csv")
with open(output_path, "w", newline="", encoding="utf-8") as file:
    writer = csv.writer(file)
    writer.writerows(data)

print(f"CSV file 'fd7_form.csv' has been created successfully at {output_path}.")